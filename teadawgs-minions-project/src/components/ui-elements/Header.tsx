    ...
    return (
        <div className="flex justify-center items-center bg-red-400 w-full h-20 space-x-2 shadow-lg">
            ...
            <div className="absolute right-4 flex items-center space-x-4">
                <span className={`font-roboto text-2xl`}>{"Welcome, "}</span>
                <button onClick={() => router.push("/")} className="flex items-center justify-between border-solid border-2 border-black rounded-full bg-black p-2 hover:bg-gray-700 transition duration-300 mr-4 cursor-pointer">
