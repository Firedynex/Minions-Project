            ...
            <div className="absolute bottom-8 w-full">
                <div className="flex justify-between gap-30"
                    style={{
                        ...
                        <button onClick={() => handleSubmit(true)} className="flex justify-center items-center gap-2 bg-[#757575] px-8 py-3 rounded-lg hover:bg-[#858585] transition-colors w-[40%]">
                        ...
                        <button onClick={() => handleSubmit(false)} className="flex justify-center items-center gap-2 bg-[#E54747] px-8 py-3 rounded-lg hover:bg-[#F55757] transition-colors w-[40%] ml-2" style={{marginRight: 'auto'}}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#D8D8D8" className="size-6">
